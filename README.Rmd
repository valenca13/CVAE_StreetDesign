...
We extracted street images from the Mapillary database. Then performed a manual filtering process, removing images of low quality. The database after filtered can be found [here](Dataset/Images/). To avoid overfitting, we performed image augmentation to the filtered images. 
