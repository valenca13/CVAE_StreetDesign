...
a) The original dataset used for [Training]("Dataset/Images/Train_filtered/") and [Test]("Dataset/Images/Test_filtered/") filtered manually, without augmentation.
...
We share the codes in R used for the preprocessing of the images (image augmentation and object detection) and also to perform the variational autoenconder (only images as inputs) and the conditional variational autoencoder (images and features as inputs). 
...
a. [Image Augmentation](Guidelines/Image_Augmentation.md)

b. [Object Detection](Guidelines/Object_Detection.md)

##### Generative Deep Modelling

c. [Variational Autoencoder](Guidelines/VAE.md)

d. [Conditional Variational Autoencoder](Guidelines/CVAE.md)
